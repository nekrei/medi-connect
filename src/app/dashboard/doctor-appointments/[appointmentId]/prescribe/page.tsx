...
export default async function PrescribePage(props: { params: Promise<{ appointmentId: string }> }) {
    ...
    try {
        const res = await client.query(
            `SELECT a.patientid, c.doctorid, a.appointmentdate, a.status
             FROM appointments a 
    ...
    if (appointment.status !== 'Scheduled') {
        return <div className="p-8 text-center text-red-500">This appointment is no longer active for profile access.</div>;
    }
