...
export default async function PatientHistoryPage({ params }: { params: Promise<{ patientId: string }> }) {
    ...
    // Ideally, secure this to check if user has granted access right now, 
    // but the button ensures it only appears if granted for an appointment.
        ...
        <main className="min-h-screen bg-slate-50 p-6 md:p-12">
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
                    ...
                    <p className="text-slate-500 mb-8">Review past prescriptions, notes, and medical records for Patient #{patientId}.</p>
